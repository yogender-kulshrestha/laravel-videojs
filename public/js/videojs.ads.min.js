                        ...
                        t.addEventListener(
                            ...
                            function (e) {
                                ...
                                n &&
                                    ...
                                    (r[n.callId](n.returnValue, n.success),
                                    (r[n.callId] = null));
                            },
                            !1
                        );
            ...
            processMetadataTracks: function (e, t) {
                for (
                    var n = e.textTracks(),
                        a = function (n) {
                            "metadata" === n.kind &&
                                (e.ads.cueTextTracks.setMetadataTrackMode(n),
                                t(e, n));
                        },
                        o = 0;
                    o < n.length;
    ...
    var F = A.isMiddlewareMediatorSupported,
        ...
        q = function (o) {
            ...
            U.concat(["firstplay", "loadedalldata"]).forEach(function (e) {
                ...
                r.on("ended", function () {
                    r.hasClass("vjs-has-started") ||
                        r.addClass("vjs-has-started");
                }),
                ...
                r.on(["addurationchange", "adcanplay"], function () {
                    if (
                        ...
                        !r.hasStarted() &&
                        (!r.ads.snapshot ||
                            r.currentSrc() !== r.ads.snapshot.currentSrc) &&
                        r.ads.inAdBreak()
                    ) {
                        var t = r.play();
                        t &&
                ...
                (r.ads.adMacroReplacement = function (a, o, r) {
                    ...
                    (d["{player.id}"] =
                        this.options_["data-player"] || this.id_),
                    (d["{player.height}"] = this.currentHeight()),
                    (d["{player.width}"] = this.currentWidth()),
                    (d["{mediainfo.id}"] = this.mediainfo
                        ? this.mediainfo.id
                        : ""),
                    (d["{mediainfo.name}"] = this.mediainfo
                        ? this.mediainfo.name
                        : ""),
