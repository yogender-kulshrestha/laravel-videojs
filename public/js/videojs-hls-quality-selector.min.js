        ...
        function ConcreteButton(player) {
            ...
            return possibleConstructorReturn(
                ...
                _VideoJsButtonClass.call(this, player, {
                    title: player.localize("Content Quality"),
                })
            );
        }
    ...
    var HlsQualitySelectorPlugin = (function () {
        ...
        function HlsQualitySelectorPlugin(player, options) {
            ...
            if (this.player.qualityLevels && this.getHls()) {
                ...
                this.createQualityButton(options);
        ...
        HlsQualitySelectorPlugin.prototype.createQualityButton =
            function createQualityButton(options) {
                var player = this.player;

                this._qualityButton = new ConcreteButton(player);

                var placementIndex = player.controlBar.children().length - 1;
                ...
                ).className += " vjs-icon-cog custom-quality-selector";

                concreteButtonInstance.removeClass("vjs-hidden");

                if (options.IsHd) {
                    var cntrollBar = document.querySelector(
                        ".vjs-quality-selector button"
                    );
                    var create = document.createElement("span");
                    create.classList.add("quality-label-hd");
                    create.innerHTML = "HD";
                    cntrollBar.appendChild(create);
                }
            };
            ...
            function onAddQualityLevel() {
                ...
                levelItems.push(
                    this.getQualityMenuItem.call(this, {
                        label: player.localize("Automatic"),
                        value: "auto",
                        selected: true,
                    })
                );
                ...
                var _loop = function _loop(i) {
                    if (
                        ...
                        var levelItem = _this.getQualityMenuItem.call(_this, {
                            ...
                            label:
                                levels[i].height >= 720
                                    ? levels[i].height + "p HD"
                                    : levels[i].height + "p SD", // line A
